...
export default async function reservationPage({
  ...
  return (
    <>
      ...
      <section className="flex flex-wrap justify-center h-full p-3 transition-all ease-in-out">
        ...
        <div>
          <div key={facility} className=" flex flex-col  p-2 ">
            <div className="flex  border-gray-700 dark:border-white  drop-shadow-md  max-w-[900px] m-3 p-4 border-2">
