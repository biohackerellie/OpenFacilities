            ...
            <div className="justify-between my-5  gap-36">
              <div className="flex flex-col my-2 p-2  justify-between text-xl border-b-2 border-b-gray-700 dark:border-b-white text-justify ">
                <p>
                  ...
                  along with any requirement for insurance coverage. If you do
                  not provide the required coverage for the event by the listed
                ...
                <div className="text-sm dark:bg-gray-500 bg-gray-300 p-5 m-2">
                  <p>
                    ...
                    certificate of insurance and endorsement to their property
                    and liability policy. Said certificate and policy
                    endorsement shall name the District as an additional
                    insured. The certificate and policy shall show coverage for
                    comprehensive general liability insurance for injuries to or
                    death of any person or damage to or loss of property arising
                    out of or in any way resulting from the described use of the
                    facility. The insurance shall provide for amounts not less
                    than $1,000,000 for bodily injury or death to any one person
                    or resulting from any one accident, and $1,000,000 for
                    property damage in any one accident or the policy may
                    provide a combined single limit for bodily injury and
                    property damage for $1,000,000. The certificate shall
                    contain a provision that the insurer not cancel or refuse to
                    renew without giving the District written notice at least 10
                    days before the effective date of the cancellation or
                    non-renewal.
                  </p>
                </div>
              </div>
              <div className="p-2">
                ...
                <div className="flex flex-wrap bg-gray-300 dark:bg-gray-500 p-5 m-3">
                  <h3 className="m-2 border-b-2 mb-5">
                    ...
                    <strong> Laurel Public Schools </strong> as an additional
                    insured.{' '}
                  </h3>
