...
export default function CalendarMain({ fetchedEvents }: { fetchedEvents: Events[] }) {
		...
		<div>
			<div className="hidden sm:visible sm:flex h-5 justify-center items-center space-x-4 text-sm">
				<div className="">
					<Button
						variant="link"
						className={`${selectedBuilding === 'Master'
							? 'text-blue-500'
							: 'text-foreground'
							}`}
				...
				<div>
					<Button
						variant="link"
						className={`${selectedBuilding === 'Graff Elementary'
							? 'text-blue-500'
							: 'text-foreground'
							}`}
				...
				<div>
					<Button
						variant="link"
						className={`${selectedBuilding === 'Laurel High School'
							? 'text-blue-500'
							: 'text-foreground'
							}`}
				...
				<div>
					<Button
						variant="link"
						className={`${selectedBuilding === 'Laurel Middle School'
							? 'text-blue-500'
							: 'text-foreground'
							}`}
				...
				<div>
					<Button
						variant="link"
						className={`${selectedBuilding === 'West Elementary'
							? 'text-blue-500'
							: 'text-foreground'
							}`}
				...
				<div>
					<Button
						variant="link"
						className={`${selectedBuilding === 'South Elementary'
							? 'text-blue-500'
							: 'text-foreground'
							}`}
				...
				<div>
					<Button
						variant="link"
						className={`${selectedBuilding === 'Administration Building'
							? 'text-blue-500'
							: 'text-foreground'
							}`}
				...
				<div>
					<Button
						variant="link"
						className={`${selectedBuilding === 'Laurel Stadium'
							? 'text-blue-500'
							: 'text-foreground'
							}`}
